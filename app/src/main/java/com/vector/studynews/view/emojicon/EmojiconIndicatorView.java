...
public class EmojiconIndicatorView extends LinearLayout {
    ...
    public EmojiconIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context,attrs);
    }
    public void init(Context context,AttributeSet attrs){
        this.context = context;
        dotHeight = DensityUtil.dip2px(context,dotHeight);
        selectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.mipmap.dot_emojicon_selected);
        unselectedBitmap = BitmapFactory.decodeResource(context.getResources(),R.mipmap.dot_emojicon_unselected);
